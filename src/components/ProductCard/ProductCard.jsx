    ...
    >
      ...
      <div className="relative overflow-hidden h-64 md:h-72 bg-gradient-to-br from-light-gray to-gray-200">
        ...
        <button
          ...
          className={`absolute top-4 right-4 w-9 h-9 rounded-full flex items-center justify-center transition-all duration-300 shadow-md ${
        ...
        <div className="absolute inset-x-0 bottom-0 translate-y-full group-hover:translate-y-0 transition-transform duration-400 p-4 bg-gradient-to-t from-black/80 to-transparent">
          <Link
            ...
            className="flex items-center justify-center gap-2 w-full py-2 rounded-full bg-white/20 backdrop-blur-sm border border-white/30 text-white text-sm font-medium hover:bg-white/30 transition-colors"
          >
      ...
      <div className="p-5 flex flex-col flex-1">
        ...
        <div className="flex gap-2 mt-auto">
          <Link
            to={`/product/${product.id}`}
            className="flex-1 btn-outline-accent text-center justify-center py-2.5 text-sm"
          >
            View Details
          </Link>
          <a
            ...
            className="flex-1 btn-whatsapp justify-center py-2.5 text-sm"
          >
